...
const PrivacyPage: React.FC = () => {
  return (
    <div className={css(styles.container)}>
      ...
      <p>
        Actually Colab built the Actually Colab app as an Open Source app. This SERVICE is provided by Actually Colab at
      ...
      <p>
        ...
        at Actually Colab unless otherwise defined in this Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        identifiable information, including but not limited to email. The information that we request will be retained
