  ...
  return (
    <div className={css(styles.container)}>
      ...
      <p>
        ...
        the app, or our trademarks in any way. You’re not allowed to attempt to extract the source code of the app, and
        you also shouldn’t try to translate the app into other languages, or make derivative versions. The app itself,
        and all the trade marks, copyright, database rights and other intellectual property rights related to it, still
        belong to Actually Colab.
      </p>
      <p>
        Actually Colab is committed to ensuring that the app is as useful and efficient as possible. For that reason, we
      ...
      <p>
        The Actually Colab app stores and processes personal data that you have provided to us, in order to provide our
        ...
        Actually Colab app won’t work properly or at all.
      </p>
      <div>
      ...
      <p>
        You should be aware that there are certain things that Actually Colab will not take responsibility for. Certain
        functions of the app will require the app to have an active internet connection. The connection can be Wi-Fi, or
        provided by your mobile network provider, but Actually Colab cannot take responsibility for the app not working
      ...
      <p>
        Along the same lines, Actually Colab cannot always take responsibility for the way you use the app i.e. You need
        to make sure that your device stays charged – if it runs out of battery and you can’t turn it on to avail the
        Service, Actually Colab cannot accept responsibility.
      </p>
      <p>
        With respect to Actually Colab’s responsibility for your use of the app, when you’re using the app, it’s
        important to bear in mind that although we endeavour to ensure that it is updated and correct at all times, we
        do rely on third parties to provide information to us so that we can make it available to you. Actually Colab
      ...
      <p>
        ...
        need to download the updates if you want to keep using the app. Actually Colab does not promise that it will
        always update the app so that it is relevant to you and/or works with the version that you have installed on
